...
\chapter{Lecture 1: Visualisation}\label{lecture-1-visualisation}}
...
\chapter{Lecture 2: Data wrangling 1}\label{lecture-2-data-wrangling-1}}
...
\section{In class}\label{in-class-1}}

In class we will go through the notebook of lecture 2

\hypertarget{lecture-3-data-wrangling-2}{%
\chapter{Lecture 3: Data wrangling 2}\label{lecture-3-data-wrangling-2}}
...
\section{In class}\label{in-class-2}}
...
\chapter{Lecture 4: Functions and knitr}\label{lecture-4-functions-and-knitr}}
...
\section{In class}\label{in-class-3}}

\hypertarget{lecture-5-generating-data-and-some-statistics}{%
\chapter{Lecture 5: Generating data and some statistics}\label{lecture-5-generating-data-and-some-statistics}}
...
\section{In class}\label{in-class-4}}
...
\chapter{Generating data}\label{generating-data}}
...
\hypertarget{creating-documents}{%
\chapter{Creating documents}\label{creating-documents}}

using knitr to create PDF / HTML reports, papers, presentations etc.

\hypertarget{creating-maps}{%
\chapter{Creating maps}\label{creating-maps}}
